...
QImage Segmentation::getSegmentedImage()
{
    ...
    return cvMatToQImage(segmentedImage);
}
...
bool Segmentation::minimizeEnergy()
{
    ...
    //Initializing a sparse LDLT Cholesky factorization class
    //and solving the linear equation Av = b for v
//    Eigen::SimplicialLDLT<Eigen::SparseMatrix<double> > ldlt(A);
//    Eigen::SimplicialLLT<Eigen::SparseMatrix<double> > ldlt(A);
...
//    solver.preconditioner().setFillfactor(10);  //Get the reference of the preconditioner and set properties
//    solver.setTolerance(tol);

    Eigen::SimplicialLDLT<Eigen::SparseMatrix<double> > ldlt;
//    Eigen::CholmodSupernodalLLT<Eigen::SparseMatrix<double> > ldlt;
